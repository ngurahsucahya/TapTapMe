...
bagianTubuh1 = cv2.imread("../../demo/SucahyaNoBG.png")  # Provide the path to your first bagianTubuh file
bagianTubuh2 = cv2.imread("../../demo/SucahyaNoBG.png")  # Provide the path to your second bagianTubuh file
...
while True:
    ...
    green_background[rect1_position[1]:rect1_position[1] + rect_size, rect1_position[0]:rect1_position[0] + rect_size] = image_resized1

    # Overlay the second bagianTubuh onto the green background
    image_resized2 = cv2.resize(bagianTubuh2, (rect2_size, rect2_size))
    green_background[rect2_position[1]:rect2_position[1] + rect2_size, rect2_position[0]:rect2_position[0] + rect2_size] = image_resized2
